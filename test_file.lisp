...
;;I think that the issue that I am having is with parameters? they might be updating the vars in an enclosing scope rather than creating a new local one. Nope that's not it. update var is only called when a user defines a variable